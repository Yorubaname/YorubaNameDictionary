...
public class NamesStateCountAndSubmittedByTestData : IEnumerable<object[]>
{
    ...
    {
        yield return new object[] { NameEntries(), State.NEW, 4, CreatedByAdeshina };
        yield return new object[] { NameEntries(), State.PUBLISHED, 5, CreatedByIsmaila };
    }
